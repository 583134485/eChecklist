...
namespace Gdc.Apps.Echecklist.Web.Controllers
{
    public class StepController : ApiController
    {
        ...
        //[HttpPost]
        //[ActionName("listworkflow_step")]
        //public StepView Getworkflow_step([FromBody]Step step)
        //{
        //    return stepService.GetStepsByWorkflowId(step);
        //}

        [HttpPost]
        [ActionName("getone")]
        public Step GetoneStep([FromBody]Step instance)
        {
            //stepService.;
            return null;
        }
        ...
        {
          //  List<Winstance> list = new List<Winstance>();
         // StepView stepView = stepService.GetOneStepById(step);
            //list.Add(stepView.Data.Winstance);
